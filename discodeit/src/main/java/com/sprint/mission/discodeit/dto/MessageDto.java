...
public class MessageDto {
    ...
    public record MessageCreateRequest(
            ...
            @Schema(description = "작성자의 ID", example = "a1b2c3d4-e5f6-7890-1234-567890abcdef", requiredMode = RequiredMode.REQUIRED)
            UUID authorId
    ) {
    ...
    public record MessageResponse(
            @Schema(description = "메시지 ID", example = "f0e9d8c7-b6a5-4321-fedc-ba9876543210")
            UUID id,
            ...
            @Schema(description = "작성자 ID", example = "a1b2c3d4-e5f6-7890-1234-567890abcdef")
            UUID authorId,
            ...
            @Schema(description = "메시지 수정 시각", example = "2025-07-10T10:40:00Z")
            Instant updatedAt
    ) {
    ...
    public record MessageUpdateRequestDto(
            @Schema(description = "업데이트될 새로운 메시지 내용", example = "내용을 수정합니다.", requiredMode = RequiredMode.REQUIRED)
            String newContent,
            MultipartFile newAttachment //optional
    ) {
