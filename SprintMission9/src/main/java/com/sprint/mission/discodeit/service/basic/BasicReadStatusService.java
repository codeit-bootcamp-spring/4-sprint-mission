...
public class BasicReadStatusService implements ReadStatusService {
  ...
  public ReadStatusDto create(ReadStatusCreateRequest request) {
    ...
    log.info("읽음 상태 생성 완료: id={}, userId={}, channelId={}", readStatus.getId(), userId, channelId);
  ...
  public List<ReadStatusDto> findAllByUserId(UUID userId) {
    ...
    List<ReadStatusDto> dtos =
        readStatusRepository.findAllByUserId(userId).stream().map(readStatusMapper::toDto).toList();
