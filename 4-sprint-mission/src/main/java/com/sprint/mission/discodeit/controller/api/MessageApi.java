...
public interface MessageApi {
    ...
    ResponseEntity update(@Parameter(description = "수정할 Message ID")
    ...
    ResponseEntity delete(@Parameter(description = "삭제할 Message ID")
                          @NotNull(message = "잘못된 ID 입니다.")
                          @PathVariable("message-id") UUID messageId);
    ...
    ResponseEntity findAllByChannelId(@Parameter(description = "조회할 Channel ID")
                                      @NotNull(message = "잘못된 ID 입니다.")
                                      @RequestParam UUID channelId,
                                      @Parameter(description = "페이징 커서 정보", schema = @Schema(format = "date-time"))
