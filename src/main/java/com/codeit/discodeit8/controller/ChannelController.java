...
import com.codeit.discodeit8.swagger.SwaggerChannelController;
...
public class ChannelController {
  ...
  public ResponseEntity<ChannelDto> createPrivateChannel(
    ...
    log.info("[POST /api/channels/private] 요청 수신: participantIds={}",
        privateChannelCreateRequest.getParticipantIds());
