...
import com.codeit.discodeit8.exception.binarycontentstorage.BinaryContentStorageFailDownloadFileException;
import com.codeit.discodeit8.exception.binarycontentstorage.BinaryContentStorageFailReadFileException;
import com.codeit.discodeit8.exception.binarycontentstorage.BinaryContentStorageFailSaveFileException;
...
public class LocalBinaryContentStorage implements BinaryContentStorage {
  ...
  public LocalBinaryContentStorage(
      @Value("${discodeit.storage.local.root-path}") String rootPathStr) {
