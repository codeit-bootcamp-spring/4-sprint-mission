...
public interface SwaggerBinaryContentController {
  ...
  ResponseEntity<List<BinaryContent>> findAllBinaryContents(
      @Parameter(name = "binaryContentIds", description = "조회할 첨부 파일 ID 목록", required = true)
  ...
  ResponseEntity<BinaryContent> findBinaryContentById(
