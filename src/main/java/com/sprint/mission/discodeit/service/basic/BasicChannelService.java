...
public class BasicChannelService implements ChannelService {
  ...
  public ChannelDto create(PublicChannelCreateRequest request) {
    ...
    publisher.publishEvent(new ChannelCreatedEvent(dto, Instant.now()));
  ...
  public ChannelDto update(UUID channelId, PublicChannelUpdateRequest request) {
    ...
    publisher.publishEvent(new ChannelUpdatedEvent(before, after, Instant.now()));
  ...
  public void delete(UUID channelId) {
    ...
    ChannelDto snapshot = channelMapper.toDto(channel);
    ...
    publisher.publishEvent(new ChannelDeletedEvent(snapshot, Instant.now()));
