...
public interface ChannelApi {
    ...
    ResponseEntity createPublicChannel(@RequestBody PublicChannelCreateRequest publicChannelCreateRequest);
    ...
    ResponseEntity createPrivateChannel(@RequestBody PrivateChannelCreateRequest privateChannelCreateRequest);
    ...
    ResponseEntity updatePublicChannel(@Parameter(description = "수정할 Channel ID") @PathVariable("channel-id") UUID channelId, @RequestBody PublicChannelUpdateRequest publicChannelUpdateRequest);
    ...
    ResponseEntity deletePublicChannel(@Parameter(description = "삭제할 Channel ID") @PathVariable("channel-id") UUID channelId);
    ...
    ResponseEntity findChannelByUserId(@Parameter(description = "조회할 User ID") @RequestParam("userId") UUID userId);
}
