...
public interface ReadStatusApi {
    ...
    ResponseEntity findALlByUserId(@Parameter(description = "조회할 User ID")
    ...
    ResponseEntity createReadStatus(@Valid @RequestBody ReadStatusCreateRequest readStatusCreateRequest);
    ...
    ResponseEntity updateReadStatus(@Parameter(description = "수정할 읽음 상태 ID")
                                    @NotNull(message = "잘못된 ID 입니다.")
                                    @PathVariable("read-status-id") UUID readStatusId, @RequestBody ReadStatusUpdateRequest readStatusUpdateRequest);
}
