...
public class GlobalExceptionHandler {
  ...
  private HttpStatus determineHttpStatus(DiscodeitException exception) {
    ...
    return switch (errorCode) {
      ...
      case INVALID_USER_CREDENTIALS, AUTH_FAILURE, REFRESH_TOKEN_NOT_FOUND, REFRESH_TOKEN_EMPTY,
           REFRESH_TOKEN_EXPIRED, REFRESH_TOKEN_ROTATED -> HttpStatus.UNAUTHORIZED;
